        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
               ...
               if (index!=0){
                   ...
                   int number1=date2.compareTo(date1);
               if (number1!=0)return number1;
               else{
                   double sum1,sum2;
                  if (stock1.containsKey("open")){
                      sum1=(double)stock1.get("last")-(double)stock1.get("open");
                  }else {
                      sum1=(double)stock1.get("change");
                  }
                  if (stock2.containsKey("open")){
                      sum2=(double)stock2.get("last")-(double)stock2.get("open");
                  }else{
                      sum2=(double)stock1.get("change");
                  }
